...
// Use student_id from session, fallback to 'Guest' if not set
$userName = $_SESSION['student_id'] ?? 'Guest';
$userRole = isset($_SESSION['user_role']) ? ucfirst($_SESSION['user_role']) : 'Student';
$userInitials = '';

if (!empty($userName) && $userName !== 'Guest') {
  // Use first 2 characters of student_id as initials
